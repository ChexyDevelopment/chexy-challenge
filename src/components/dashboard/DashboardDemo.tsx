...
function CustomersTable() {
  return (
    <Table>
      ...
      <TableBody>
        <TableRow>
          <TableCell>Big Boi Gigone</TableCell>
        ...
        <TableRow>
          <TableCell>Baba Ahmed</TableCell>
        ...
        <TableRow>
          <TableCell>Captain America</TableCell>
          <TableCell>Pro</TableCell>
        ...
        <TableRow>
          <TableCell>Daddy Haisem</TableCell>
          <TableCell>Pro</TableCell>
